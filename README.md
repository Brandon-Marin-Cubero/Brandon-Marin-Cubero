# Brandon Marín Cubero

Desarrollador Full Stack en Cartago, Costa Rica. Trabajo principalmente con Laravel y React, y me interesa particularmente la intersección entre software, infraestructura y hardware: control de acceso con cerraduras electrónicas, autenticación NFC y microcontroladores.
...
![Tailwind](https://img.shields.io/badge/Tailwind_CSS-grey?style=flate&logo=tailwind-css&logoColor=white)
...
Arduino, ESP32, autenticación NFC, cerraduras electrónicas.
...
Técnico Medio en Desarrollo Web — Colegio Vocacional de Artes y Oficios (COVAO), Cartago
